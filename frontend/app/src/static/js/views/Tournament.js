...
export default class extends AbstractView {
    ...
    this.app.innerHTML = `
      <div class="tournament-page">
        ...
        <div id="winner-div" class="level-2-div">
          ${
            this.level >= 3
            ? `<div class="winner-holder"> <h1 class="font-heading tournament-winner-text">WINNER</h1>
                <div class="player-card-winner">${this.fillPlayerCard(this.stats.g3_winner)}</div></div>`
            : ''
          }
        ...
        <div class="info-div">
          <h2 class="font-sub info-text">${this.level < 3 ? `Click to start game ${this.level + 1}` : `Click to end tournament`}</h2>
  ...
  saveResults(results, players) {
    const winner = results.player1Score > results.player2Score ? players[0] : players[1];
    switch(this.level) {
      case 0:
        this.stats.g3_p1 = winner;
        this.stats.g1_winner = winner;
        break;
      
      case 1:
        this.stats.g3_p2 = winner;
        this.stats.g2_winner = winner;
        break;

      case 2:
        this.stats.winner = winner;
        this.stats.g3_winner = winner;
        break;
    }
  }
