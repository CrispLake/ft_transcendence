...
// ----Base Colors----
export const PURPLE = new THREE.Color(0xff00ff);
export const CYAN = new THREE.Color(0x11ffff);
export const RED = new THREE.Color(0xff1111);
export const GREEN = new THREE.Color(0x11ff11);
export const YELLOW = new THREE.Color(0xffff11);
export const ORANGE = new THREE.Color(0xff7722);
export const WHITE = new THREE.Color(0xffffff);
export const BLACK = new THREE.Color(0x000000);
export const GRAY = new THREE.Color(0x555555);
export const DARK_GRAY = new THREE.Color(0x222222);
